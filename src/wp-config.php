...
define( 'DB_NAME', fopen(string ('/bindings/db/database'), 'r'));

/** MySQL database username */
define( 'DB_USER', fopen(string('/bindings/db/username'), 'r' ));

/** MySQL database password */
define( 'DB_PASSWORD', fopen(string ('/bindings/db/password'), 'r'));

/** MySQL hostname */
define( 'DB_HOST',fopen(string ('/bindings/db/host'), 'r') . ':' . fopen(string ('/bindings/db/port'), 'r'));
